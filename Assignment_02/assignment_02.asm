...
%macro read 2
mov rax , 00   ; sys_read
mov rdi , 00   ; read from stdin
mov rsi , %1   ; address of string to read bytes
...
mov  bl  , al         ; Copy contents of al tp bl
mov  rsi , length     ; mov ans base address to rsi
